(function (j) {
    ...
    function A(a, b) {
        s === o &&
            (s =
                ...
                z
                    .serializeToString(
                        new f.DOMParser().parseFromString(
    ...
    q.ext.buttons.excelHtml5 = {
        ...
        action: function (a, b, d, c) {
            ...
            t.messageBottom &&
                (m([t.messageBottom], g), p(g, k.header.length - 1));
            m = n(i, "cols");
            ...
            0 === j("mergeCells", i).children().length &&
                j("mergeCells", i).remove();
            b = new (v || f.JSZip)();
            d = {
                type: "blob",
                mimeType:
