...
(function (e) {
                ...
                if (p)
                    if (e.isArray(p)) this._expandButton(a, p, c, d);
                        ...
                        j &&
                            ...
                            p.init &&
                                p.init.call(g.button(j.node), g, e(j.node), p),
                            f++);
                    }
            }
        },
    ...
    e.extend(o, {
        ...
        excel: function (a, b) {
            if (o.excelHtml5 && o.excelHtml5.available(a, b))
                return "excelHtml5";
            if (o.excelFlash && o.excelFlash.available(a, b))
                return "excelFlash";
        },
        pdf: function (a, b) {
    ...
    i.Api.register("buttons.exportData()", function (a) {
        if (this.context.length) {
            ...
            b.select &&
                ...
                f.selected === m &&
                b.rows(c.rows, e.extend({ selected: !0 }, f)).any() &&
                e.extend(f, { selected: !0 });
            for (
                var f = b.rows(c.rows, f).indexes().toArray(),
                    h = b.cells(f, c.columns),
                ...
                for (var r = [k], q = 0; q < k; q++)
                    (r[q] = c.format.body(f[j], n, q, h[j])), j++;
                l[n] = r;
            }
    ...
    i.Api.register("buttons.exportInfo()", function (a) {
        ...
        b === m || null === b
            ? (b = null)
            : (-1 !== b.indexOf("*") &&
                  (b = e.trim(b.replace("*", e("head > title").text()))),
        ...
        c =
            null === c
                ? null
                : -1 !== c.indexOf("*")
                ? c.replace("*", e("head > title").text() || "Exported data")
                : c;
        return {
            filename: b,
            title: c,
